...
# Path of model data
path_model = '/Volumes/MyPassport/SMAP_Project/Datasets/model_data/gldas'
...
########################################################################################################################
# 1. Implement the VIS/IR downscaling model on MODIS LST difference to calculate 1 km soil moisture (GLDAS)
...
########################################################################################################################
# 2. Downscale the 1km soil moisture model output by 9 km SMAP L2 soil moisture data (GLDAS)
